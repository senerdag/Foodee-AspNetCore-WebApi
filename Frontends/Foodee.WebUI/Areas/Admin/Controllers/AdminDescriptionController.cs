...
namespace Foodee.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminDescriptionController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7122/api/Descriptions");
        ...
        public async Task<IActionResult> UpdateDescription(UpdateDescriptionDto updateDescriptionDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7122/api/Descriptions/", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
